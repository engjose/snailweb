...
public class Menu {
     ...
     * @mbggenerated
     */
    public Menu(Integer id, Integer level, String name, String desc, Integer parentId, String app, String url, Date updateAt, Date createAt, String createBy, String updateBy, Integer status) {
        this.id = id;
        this.level = level;
        this.name = name;
        this.desc = desc;
